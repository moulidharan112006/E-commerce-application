            ...
            {error ? <Message variant='danger'>{error}</Message>
                ...
                <div>
                    <Container>
                        <Row>
                            <Col md={6}>
                                <Card.Img variant="top" src={product.image || '/fallback.png'} height="420" />
                            ...
                            <Col sm>
                                ...
                                <div className="mb-3">
                                    <b>Availability: </b>
                                    {product.stock ? <span className="text-success">In Stock</span> : <span className="text-danger">Out Of Stock</span>}
                                </div>
                                <span style={{
                                    display: "flex",
