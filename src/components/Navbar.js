    ...
    return (
        <header>
            <Navbar bg="dark" variant="dark" expand="lg" collapseOnSelect>
                <Container>
                    <LinkContainer to="/">
                        <Navbar.Brand><i className="mb-2 fas fa-store"> ShopConnect</i></Navbar.Brand>
                    </LinkContainer>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="mr-auto">
                            ...
                            {/* All Products */}
                            <LinkContainer to="/">
                                <Nav.Link><i className="fas fa-th"></i> All Products</Nav.Link>
                            </LinkContainer>

                            {/* Cart */}
                            <LinkContainer to="/cart">
                                <Nav.Link className="ml-lg-2"><i className="fas fa-shopping-cart"></i> Cart</Nav.Link>
                            </LinkContainer>
